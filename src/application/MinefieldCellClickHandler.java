...
public class MinefieldCellClickHandler implements EventHandler<MouseEvent> {
  ...
  private static void startAnimationIfStopped() {
  ...
  private static void setFlagOnThis(MinefieldCell clickedCell) {
    ...
    Minefield.getRemainingMinesStringProperty()
            .setValue(Minefield.getNumberOfRemainingMinesAsString());
  }

  private static void removeFlagFromThis(MinefieldCell clickedCell) {
  ...
  private static void displayMineOnThis(MinefieldCell cell) {
  ...
  private static void displayThisEmpty(MinefieldCell cell) {
    cell.setBorder(new Border(new BorderStroke(
            Color.GRAY,
            new BorderStrokeStyle(StrokeType.INSIDE, StrokeLineJoin.BEVEL, null, 10, 0, null),
            null, new BorderWidths(1))));
  ...
  private void revealCellsAdjacentToThis(MinefieldCell cell) {
    List<MinefieldCell> adjacentCellsList = AdjacentCellsListBuilder
            .build(Minefield.getCellsMatrix(), cell.getRow(), cell.getCol());
    for (MinefieldCell adjacentCell : adjacentCellsList) {
      revealThis(adjacentCell);
    }
  }

  private static void displayAdjacencyValueOfThis(MinefieldCell cell) {
    cell.setBorder(new Border(new BorderStroke(
            Color.GRAY,
            new BorderStrokeStyle(StrokeType.INSIDE, StrokeLineJoin.BEVEL, null, 10, 0, null),
            null, new BorderWidths(1))));
  ...
  private static void displayUnexplodedMineOnThis(MinefieldCell cell) {
    cell.setRevealed(true);
    cell.setBorder(new Border(new BorderStroke(
            Color.GRAY,
            new BorderStrokeStyle(StrokeType.INSIDE, StrokeLineJoin.BEVEL, null, 10, 0, null),
